...
// delete first core default image upload modules
delete this.ckan.module.registry["image-upload"]
	...
	return {
		...
		initialize: function () {
			...
			$('.image-upload').each(function () {
				var label_text = $(this).data('moduleUpload_label')
				$(this).find('label[for="field-image-url"]').text(label_text)
			})
